...
- **S-02: user can mark a saved maintenance task as completed and see the last completed date, next due date, and status update.** - Archived 2026-09-11 -> `context/archive/2026-09-11-complete-task-and-refresh-status/`. Lesson: -.
